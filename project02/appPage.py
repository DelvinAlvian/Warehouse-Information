...
class AppPage(tk.Frame):
	...
	def clicked_save_contact_btn(self):
		...
		confirmed = messagebox.askyesnocancel("Product Confirmation", "Are you sure you want to update this product?")
		if confirmed:
	...
	def clicked_save_new_contact_btn(self):
		...
		confirmed = messagebox.askyesnocancel("Product Confirmation", "Are you sure you want to add this product?")
		if confirmed:
			f_name = self.entry_update_contact_vars[0].get()
			l_name = self.entry_update_contact_vars[1].get()
			merk = self.entry_update_contact_vars[2].get()
